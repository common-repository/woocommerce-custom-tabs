...
class WCT_Admin_Page {
	...
	function wct_admin_init()
	{
		...
		add_settings_field(
			...
			__('Show License Activation Detailed Technical Information','wct'), // Title
			array($this, 'posttype_callback'), // Callback
			'wct_general_settings', // Page / tab page
			'wct_general_section' // Section
		);
				...
				<form method="post" action="options.php"><!--form-->  
					...
					<table class="form-table">
						...
						?>
							...
							<tr valign="top">
								<th scope="row"><?php echo __('Show License Activation Detailed Technical Information','wct') . ':' ?></th>
								<td>
									<?php
									printf(
										'<input type="hidden" name="wct_general_settings[show_activation_technical_information]" value="0"/>
										<input type="checkbox" id="show_activation_technical_information" name="wct_general_settings[show_activation_technical_information]"
										value="1"' . checked( 1, esc_attr( $options['show_activation_technical_information']), false ) . ' />'
									);
									echo '<br /><span class="description">' . __('In case of license activation problem, set this checkbox to get detailed information after license activation.','wct') . '</span>';
									?>    
								</td>
							</tr>
